...
import query from 'leads-manage/gql/queries/all-tags';
...
export default Route.extend(RouteQueryManager, {
  ...
  setPagination(pagination) {
    ...
    this.controllerFor('tag.index').setProperties({ totalCount, hasNextPage, endCursor });
  ...
  model({ first, after, sortBy, ascending }) {
    ...
    return this.get('apollo').watchQuery({ query, variables, fetchPolicy: 'network-only' }, 'allTags')
