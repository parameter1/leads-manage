...
import query from 'leads-manage/gql/queries/line-item/email/edit/leads/inactive';
import search from 'leads-manage/gql/queries/line-item/email/edit/leads/inactive-search';
...
export default Route.extend(RouteSearchMixin, {
  ...
  model({
    ...
    return this.getResults({
      query,
      queryKey: 'emailLineItemInactiveIdentities',
      queryVars: vars,
    }, {
      search,
      searchVars: vars,
      searchKey: 'searchEmailLineItemInactiveIdentities',
